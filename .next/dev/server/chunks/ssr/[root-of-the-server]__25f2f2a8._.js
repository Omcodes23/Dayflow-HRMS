...
function LoginPage() {
    ...
    async function handleLogin(e) {
        ...
        setError('');
        try {
            const { data, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email,
                password
            });
            if (authError) {
            ...
            if (data.user) {
                const { data: userData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('role').eq('id', data.user.id).single();
                if (userData?.role === 'hr') {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__25f2f2a8._.js.map